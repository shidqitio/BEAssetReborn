...
export interface ITrxBarangPersediaanDetail3Attributes {
...
class TrxBarangPersediaanDetail3
extends Model<ITrxBarangPersediaanDetail3Attributes, Optional<ITrxBarangPersediaanDetail3Attributes, 
"udcr"
|"udch">>
implements ITrxBarangPersediaanDetail3Attributes {
...
TrxBarangPersediaanDetail3.init(
	{
		nomor_dokumen : {
	...
	{
		sequelize : db,
        tableName : "trx_barang_persediaan_detail_3",
        modelName : "TrxBarangPersediaanDetail3",
        underscored : true,
        createdAt : "udcr",
        updatedAt : "udch"
	}
...
TrxBarangPersediaanDetail3.belongsTo(TrxBastPersediaan, {
	foreignKey : "nomor_dokumen",
	as : "trxbastpersediaan"
})

TrxBastPersediaan.hasMany(TrxBarangPersediaanDetail3, {
	foreignKey : "nomor_dokumen",
	as : "trxpersediaandetail3"
})

TrxBarangPersediaanDetail3.belongsTo(AssetPersediaan, {
	foreignKey : "kode_barang_persediaan",
	as : "assetpersediaan"
})

AssetPersediaan.hasMany(TrxBarangPersediaanDetail3, {
	foreignKey : "kode_barang_persediaan",
	as : "trxpersediaandetail3"
})

// TrxBarangPersediaanDetail.belongsTo(TrxBarangPersediaanHeader, {
// 	foreignKey : "kode_barang",
// 	as : "barang_header"
// })

// TrxBarangPersediaanHeader.hasMany(TrxBarangPersediaanDetail, {
// 	foreignKey : "kode_barang",
// 	as : "barang_detail"
// })
...
export default TrxBarangPersediaanDetail3
